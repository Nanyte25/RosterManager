...
Router.map(function () {
	...
	this.route("members.edit", {path: "/members/edit/:customerId", controller: "MembersEditController"});
	this.route("events", {path: "/events", controller: "EventsController"});
	this.route("upload_private", {path: "/upload_private", controller: "UploadPrivateController"});
